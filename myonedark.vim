...
let s:yellow = { "gui": "#E5C07B", "cterm": "227", "cterm16": "3" }
...
let s:white = { "gui": "#ABB2BF", "cterm": "252", "cterm16" : "7" }
...
let s:comment_grey = { "gui": "#5c6370", "cterm": "245", "cterm16": "15" }
...
call s:h("CursorLineNr", { "fg": s:cyan }) " Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
...
call s:h("PmenuSel", { "bg": s:cyan }) " Popup menu: selected item.
...
call s:h("WildMenu", { "bg": s:cyan, "fg": s:black }) " current match in 'wildmenu' completion
